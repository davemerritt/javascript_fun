...
// $(document).ready(function() {
//	$('#target').text('LEEEEEROOOOY JENKINS!');
// });
...
// $(document).ready(function() { 
// 	$('.target').eq(1).css('backgroundColor', 'blue');
// });
...
// $(document).ready(function(){
//	window.setTimeout(function(){alert('Warning!')}, 1000);
// });

// EXERCISE: Count

// Show the number of children in an alert
// Hint: you can use .children, .length and alert or you could use .find,
// .size and alert. the alert should show 5

// $(document).ready(function(){
//	var allChildren = $('.child');
//	$('.child').find( allChildren );
//	alert( "Size: " + $('.child').length );
// });
...
// $(document).ready(function(){
// 	$('#target').animate({'width': '300px', 'height': '380'});
// });
...
// $(document).ready(function(){
//	$('option').filter(':odd').css({'color': "blue", 'backgroundColor': 'white'});
// });
